use crate::config::{Config, ContainerLengthStrategy, EndiannessStrategy, OptionalStrategy};
use crate::error::{Error, Result};
use crate::parser_helper::ByteOrderConvertible;
...
impl<'de> BinaryParser<'de> {
    ...
    fn parse_container_size(&mut self) -> Result<usize> {
