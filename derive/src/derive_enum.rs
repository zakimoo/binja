...
impl BinjaEnumOpts {
    ...
    pub fn generate_binary_serialize(&self, data: &syn::DataEnum) -> TokenStream {
        let name = &self.ident;
        ...
        let repr_ty: syn::Type = syn::parse_str(&self.get_repr()).unwrap();
        let untagged = self.untagged.is_some();
    ...
    // pub fn generate_binary_parse(&self, data: &syn::DataEnum) -> TokenStream {
